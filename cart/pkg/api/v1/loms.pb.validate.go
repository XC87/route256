...
// Validate checks the field values on OrderItemCreateRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *OrderItemCreateRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on OrderItemCreateRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// OrderItemCreateRequestMultiError, or nil if none found.
func (m *OrderItemCreateRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *OrderItemCreateRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetSku() <= 0 {
		err := OrderItemCreateRequestValidationError{
			field:  "Sku",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return OrderItemCreateRequestMultiError(errors)
	}

	return nil
}

// OrderItemCreateRequestMultiError is an error wrapping multiple validation
// errors returned by OrderItemCreateRequest.ValidateAll() if the designated
// constraints aren't met.
type OrderItemCreateRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OrderItemCreateRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OrderItemCreateRequestMultiError) AllErrors() []error { return m }

// OrderItemCreateRequestValidationError is the validation error returned by
// OrderItemCreateRequest.Validate if the designated constraints aren't met.
type OrderItemCreateRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OrderItemCreateRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OrderItemCreateRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OrderItemCreateRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OrderItemCreateRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OrderItemCreateRequestValidationError) ErrorName() string {
	return "OrderItemCreateRequestValidationError"
}

// Error satisfies the builtin error interface
func (e OrderItemCreateRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sOrderItemCreateRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OrderItemCreateRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = OrderItemCreateRequestValidationError{}
...
// Validate checks the field values on OrderItemInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *OrderItemInfoResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on OrderItemInfoResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// OrderItemInfoResponseMultiError, or nil if none found.
func (m *OrderItemInfoResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *OrderItemInfoResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return OrderItemInfoResponseMultiError(errors)
	}

	return nil
}

// OrderItemInfoResponseMultiError is an error wrapping multiple validation
// errors returned by OrderItemInfoResponse.ValidateAll() if the designated
// constraints aren't met.
type OrderItemInfoResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OrderItemInfoResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OrderItemInfoResponseMultiError) AllErrors() []error { return m }

// OrderItemInfoResponseValidationError is the validation error returned by
// OrderItemInfoResponse.Validate if the designated constraints aren't met.
type OrderItemInfoResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OrderItemInfoResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OrderItemInfoResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OrderItemInfoResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OrderItemInfoResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OrderItemInfoResponseValidationError) ErrorName() string {
	return "OrderItemInfoResponseValidationError"
}

// Error satisfies the builtin error interface
func (e OrderItemInfoResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sOrderItemInfoResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OrderItemInfoResponseValidationError{}
