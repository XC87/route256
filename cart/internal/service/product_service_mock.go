...
//go:generate minimock -i route256.ozon.ru/project/cart/internal/service.ProductService -o product_service_mock.go -n ProductServiceMock -p service
...
type ProductServiceMock struct {
	...
	funcGetProduct          func(sku int64) (pp1 *product.ProductGetProductResponse, err error)
...
type ProductServiceMockGetProductResults struct {
	pp1 *product.ProductGetProductResponse
	err error
}
...
func (mmGetProduct *mProductServiceMockGetProduct) Return(pp1 *product.ProductGetProductResponse, err error) *ProductServiceMock {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductServiceMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductServiceMockGetProduct) Set(f func(sku int64) (pp1 *product.ProductGetProductResponse, err error)) *ProductServiceMock {
	if mmGetProduct.defaultExpectation != nil {
...
func (e *ProductServiceMockGetProductExpectation) Then(pp1 *product.ProductGetProductResponse, err error) *ProductServiceMock {
	e.results = &ProductServiceMockGetProductResults{pp1, err}
	return e.mock
}

// GetProduct implements ProductService
func (mmGetProduct *ProductServiceMock) GetProduct(sku int64) (pp1 *product.ProductGetProductResponse, err error) {
