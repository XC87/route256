...
//go:generate minimock -i route256.ozon.ru/project/cart/internal/service.Repository -o repository_mock.go -n RepositoryMock -p service
...
// DeleteItemsByUserId implements Repository
...
// GetItemsByUserId implements Repository
